...
DYLD_LIBRARY_PATH=$DEPENDS_DIR/libjpeg_turbo/lib
...
./configure --disable-dependency-tracking --host x86_64-apple-darwin NASM=/usr/local/Cellar/nasm/2.11.06/bin/nasm --with-jpeg8 --prefix=$LIBJPEG_INSTALL_DIR
make && make install
